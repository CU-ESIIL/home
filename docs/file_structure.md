...
- `docs/assets/` – shared static assets used in the documentation
  ...
  - `backgrounds/` – shared visual backdrops and atmospheric imagery
  - `branding/` – active site logos, lockups, and favicon assets
  - `collaborating-on-the-cloud/` – screenshots for cloud onboarding docs
